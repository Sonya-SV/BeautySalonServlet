    ...
    <div class="navbar-fixed-top">
        <div class="navbar navbar-default">
            ...
            <ul class="nav navbar-nav">
                <li><a href="${pageContext.request.contextPath}/beauty-salon/user/masterlist"><fmt:message key="masters"/></a></li>
                <li><a href="${pageContext.request.contextPath}/beauty-salon/user/categorylist"><fmt:message key="categories"/></a></li>
            </ul>
