...
<div class="container" style="margin-top: 100px">
    <div class="row">
        ...
        <div class="col-md-7" style="margin-top: 20px">
            <form action="${pageContext.request.contextPath}/beauty-salon/master/save">
                <c:if test="${alreadyBooked ne null}">
                    <div class="alert alert-danger">
                            ${alreadyBooked}

                    </div>
                        <a href="${pageContext.request.contextPath}/beauty-salon/master/booking?masterId=${schedule.master.id}&procedureId=${schedule.procedure.id}">
                            Choose another date
                        </a>
                </c:if>
