...
<body>
<%@ include file="masterpart/masternavbar.jsp" %><div class="container" style="margin-top: 60px">
    <div class="row">
        <form action="${pageContext.request.contextPath}/beauty-salon/master/master" autocomplete="off" novalidate >
