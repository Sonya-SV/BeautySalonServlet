    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <c:if test="${discrepancy ne null}">
                ...
                <a href="${pageContext.request.contextPath}/beauty-salon/master/master?masterId=${schedule.master.id}">
                    Choose another procedure
                </a>
            </c:if>
            <c:forEach items="${scheduleDate}" var="date">
                <form action="${pageContext.request.contextPath}/beauty-salon/master/order" role="form">
                    <ul class="media-list">
                    <li class="media">
