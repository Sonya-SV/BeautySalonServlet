        ...
        <div class="navbar navbar-default">
            <div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath}/beauty-salon/admin/masterList">Masters</a></li>
                    <li><a href="${pageContext.request.contextPath}/beauty-salon/admin/categoryList">Categories</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li><a><span class="glyphicon glyphicon-user"></span> ${sessionScope.user.email}</a></li>
                    <li><a href="${pageContext.request.contextPath}/beauty-salon/admin/profile"> Profile</a></li>
