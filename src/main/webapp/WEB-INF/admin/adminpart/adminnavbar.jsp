...
<head>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"/>
    ...
    <link rel="stylesheet"
          href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-beta/js/bootstrap.min.js"/>
    ...
    <div class="navbar-fixed-top">
        ...
        <div class="navbar navbar-default">
            ...
            <ul class="nav navbar-nav">
                <li><a href="${pageContext.request.contextPath}/beauty-salon/admin/userlist"><fmt:message
                        key="user.list"/></a></li>
                <li><a href="${pageContext.request.contextPath}/beauty-salon/admin/masterlist"><fmt:message
                        key="masters"/></a></li>
                <li><a href="${pageContext.request.contextPath}/beauty-salon/admin/categorylist"><fmt:message
                        key="categories"/></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a><span class="glyphicon glyphicon-user"></span> ${sessionScope.user.email}</a></li>
                <li><a href="${pageContext.request.contextPath}/beauty-salon/admin/profile"> <fmt:message
                        key="profile"/></a></li>
